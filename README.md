...
conflict between ``argv`` options and options automatically generated by
kitchen-qemu. Using ``argv`` to add more devices needed for a test should be
